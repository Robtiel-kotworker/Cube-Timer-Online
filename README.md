...
*(Überspringen, wenn du die mitgelieferte `config.js` unverändert nutzt — das Schema wurde dort bereits importiert.)*
...
- `app.js` — komplette App-Logik (Timer, Login, Bestenliste, Statistik, Cheat-Erkennung)
